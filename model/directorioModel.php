...
include_once "model/filtroStrategy/filtros/filtroAnio.php";
include_once "model/filtroStrategy/filtros/filtroTipoGenero.php";
include_once "model/filtroStrategy/filtros/filtroEstadoTipo.php";
include_once "model/filtroStrategy/filtros/filtroGeneroEstado.php";
include_once "model/filtroStrategy/filtros/filtroTipoEstadoAnio.php";
include_once "model/filtroStrategy/filtros/filtroTipoEstadoAnio.php";
include_once "model/filtroStrategy/filtros/filtroGeneroTipoEstado.php";
include_once "model/filtroStrategy/filtros/filtroGeneroTipoAnio.php";
...
class DirectorioModel extends Model
{
    ...
    function filtrar($genre, $anio, $estado, $tipo, $page, $limit)
    {
        ...
        // /******************************************************************************
        //  * EL SIGUIENTE FILTRO ES PARA CUANDO LAS CATEGORIAS GENERO TIPO Y ESTADO ESTEN SETEADAS
        //  * *************************************************************************** */
        if (!($genre == 'DEFAULT') && !($tipo == 'DEFAULT') && !($estado == 'DEFAULT') && ($anio == 'DEFAULT')) {
            $filtro = new Context(new FiltroGeneroTipoEstado);
            $item = $filtro->filtrar($data, $page, $limit);
            return $item;
        }
        ...
        //  * *************************************************************************** */
        if (($genre == 'DEFAULT') && !($tipo == 'DEFAULT') && !($estado == 'DEFAULT') && !($anio == 'DEFAULT')) {
            $filtro = new Context(new FiltroTipoEstadoAnio);
            $item = $filtro->filtrar($data, $page, $limit);
            return $item;
        }
         ...
         * *************************************************************************** */
        if (!($genre == 'DEFAULT') && !($tipo == 'DEFAULT') && ($estado == 'DEFAULT') && ($anio == 'DEFAULT')) {
            $filtro = new Context(new FiltroTipoGenero);
            $item = $filtro->filtrar($data, $page, $limit);
            return $item;
        }
        // /******************************************************************************
