...
class FiltroGenero extends UseGenero {
    ...
    public function filtrar_genero($data, $page, $limit)
    {
        ...
        // }
        $statement = $this->connect()->query("SELECT * FROM animes INNER JOIN generos_series ON animes.id = generos_series.id_serie 
        WHERE generos_series.id_genero = '$data[0]'");//LIMIT PARA LA PAGINACION
